...
{
    public class MeteorBallFriendly : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(projectile.Center + new Vector2(0, -25), Vector2.Zero, ModContent.ProjectileType<MeteorBallSplashDamageFriendly>(), 15, 10);
